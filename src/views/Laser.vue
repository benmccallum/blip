...
<script>
  ...
  import GooglePageSpeed from '../components/GooglePageSpeed.vue';
  import GooglePageSpeedDetails from '../components/GooglePageSpeedDetails.vue';
  import IsHtml5 from '../components/IsHtml5.vue';
  import IsHtml5Details from '../components/IsHtml5Details.vue';
  import MozillaObservatory from '../components/MozillaObservatory.vue';
  import MozillaObservatoryDetails from '../components/MozillaObservatoryDetails.vue';
